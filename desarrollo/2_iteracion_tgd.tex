...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.5\linewidth]{imagenes/login.png}
  \caption{ \textit{Login} en la aplicación móvil}
  \label{fig:login}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.5\linewidth]{imagenes/login_1.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.5\linewidth]{imagenes/detalle.png}
  \caption{Información detallada de un Local}
  \label{fig:login}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.5\linewidth]{imagenes/comentario_completo.png}
  \caption{Comentario Completo}
  \label{fig:register}
\end{minipage}%
