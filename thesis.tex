...
% Pagina de resumen
\input{intro/acta.tex}

% Pagina de resumen
\input{intro/resumen.tex}

% Pagina de dedicatoria (opcional)
\input{intro/dedicatoria.tex}
...
\input{entorno_empresarial/0_entorno_empresarial.tex}
\input{entorno_empresarial/1_antecedentes.tex}
%\input{entorno_empresarial/2_mision_vision.tex}
\input{entorno_empresarial/3_estructura_organizacional.tex}
%\input{entorno_empresarial/4_ubicacion.tex}

%\input{definicion_proyecto/0_definicion_proyecto.tex}
%\input{definicion_proyecto/1_motivacion.tex}
%\input{definicion_proyecto/2_planteamiento_solucion.tex}
%\input{definicion_proyecto/3_objetivo_general.tex}
%\input{definicion_proyecto/4_objetivos_especificos.tex}
%\input{definicion_proyecto/5_alcance.tex}

\input{marco_teorico/0_marco_teorico.tex}
\input{marco_teorico/1_aspectos_negocio.tex}
\input{marco_teorico/2_aspectos_tecnologicos.tex}

\input{marco_metodologico/0_marco_metodologico.tex}
\input{marco_metodologico/1_scrum.tex}
\input{marco_metodologico/2_TDD_BDD.tex}

\input{desarrollo/0_desarrollo.tex}
\input{desarrollo/1_situacion_actual.tex}
\input{desarrollo/2_iteracion_tgd.tex}
\input{desarrollo/3_resultados.tex}
\input{desarrollo/4_conclusiones.tex}
